...
public class SpecialSoftwareService extends Service implements TrackingSystemHttpResponse,
    ...
    private BroadcastReceiver changeLocationIntervalBroadcastReceiver;
    ...
    public void onCreate() {
        ...
        changeLocationIntervalBroadcastReceiver = new BroadcastReceiver() {
            @Override
    ...
    protected LocationRequest createLocationRequest() {
        ...
        long interval = PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getLong(Constants.LOCATION_INTERVAL, Constants.INTERVAL_LOCATION_REQUEST);
        long fastestInterval = PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getLong(Constants.LOCATION_FASTEST_INTERVAL, Constants.FASTEST_INTERVAL_LOCATION_REQUEST);
...
//                        }
    ...
    private void registerReceiver(){
        if(!isReceiverRegistered) {
            LocalBroadcastManager.getInstance(this).registerReceiver(changeLocationIntervalBroadcastReceiver,
                    new IntentFilter(Constants.CHANGE_LOCATION_INTERVAL));
    ...
    public void changeLocationInterval(){
